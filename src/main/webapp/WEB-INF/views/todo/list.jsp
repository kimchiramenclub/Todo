                    ...
                    <div class="card-body">
                        ...
                        <form action="/todo/list" method="get">
                            ...
                            <div class="input-group mb-3 dueDateDiv">
                                <input type="date" name="from" class="form-control" value="${pageRequestDto.from}" <%--max="<%= java.time.LocalDate.now() %>"--%>>
                                <input type="date" name="to" class="form-control"  value="${pageRequestDto.to}" <%--max="<%= java.time.LocalDate.now() %>"--%>>
